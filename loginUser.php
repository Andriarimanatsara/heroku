...
<body style="color: var(--bs-green);background: var(--bs-light);">
    <h3 style="text-align:center;background: rgb(133,189,241);">User</h1>
    <section class="login-clean" style="margin-top:-15%;background: rgb(133,189,241);height: 650px;border-right-style: none;">
        <form method="post" action="liste.php" style="transform: translateY(90px);height: 388px;box-shadow: 1px 1px 9px var(--bs-green);">
            <div class="mb-3" style="transform: translateY(20px);box-shadow: 1px 1px 0px var(--bs-green);"><input class="form-control" type="email" name="nom" placeholder="Nom" style="transform: translateY(0px);"></div>
